    ...
    def gen(self, cwd, urls, proxy, headers, timeout, cookies, postdata, 
        ...
        for fuzz in data:
            ...
            for u in urls:
                ...
                if '*@*' in u:
                    isvalid += 1
                    newrl = u.replace('*@*',urllib.parse.quote(fuzz))
                    newrls.append(newrl)
                ...
                if len(headers) > 0:
                    ...
                    for h,v in headers.items():
                        ...
                        if '*@*' in h:
                            isvalid += 1
                            h1 = h.replace('*@*',urllib.parse.quote(fuzz))
                        if '*@*' in v:
                            isvalid += 1
                            v1 = v.replace('*@*',urllib.parse.quote(fuzz))
                        newheaders[h1]=v1
                else:
                    newheaders = headers
                ...
                if len(cookies) > 0:
                    ...
                    for c,v in cookies.items():
                        ...
                        if '*@*' in c:
                            isvalid += 1
                            c1 = c.replace('*@*', urllib.parse.quote(fuzz))
                        if '*@*' in v:
                            isvalid += 1
                            v1 = v.replace('*@*', urllib.parse.quote(fuzz))
                        newcookies[c1]=v1
                ...
                if len(postdata) > 0:
                    ...
                    for p,v in postdata.items():
                        ...
                        if '*@*' in p:
                            isvalid += 1
                            p1 = p.replace('*@*', urllib.parse.quote(fuzz))
                        if '*@*' in v:
                            isvalid += 1
                            v1 = v.replace('*@*', urllib.parse.quote(fuzz))
                        newpostdata[p1]=v1
            ...
            if isvalid > 0:
                ...
                print('fuzzenc: Specify where with *@* and provide a wordlist using -dl [wordlist]')
                sys.exit(0)
